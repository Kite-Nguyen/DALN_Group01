                                ...
                                <div class="wrap-contact-detail">
                                    <ul>
                                        <li>
                                            ...
                                            <p class="contact-txt">Hà Nội, Việt Nam, Trái Đất</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="contact-txt">0123123123</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="contact-txt">kitenguyen2002@gmail.com</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-hotline-footer">
                                    ...
                                    <b class="phone-number">0123123123</b>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="item-content">
                                <div class="wrap-list-item social-network">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#" class="link-to-item" title="github">
