...
class CheckoutController extends Controller
{
    ...
    public function index()
    {
        if (Cart::content() !== null) {
            ...
            return view('userpage.checkout', ['data' => $data_cart]);
        } else {
            return view('userpage.checkout', ['data' => null]);
        }
    }
    ...
    public function checkoutVNPay($request)
    {
        ...
        $vnp_TmnCode = "M4XLQAWZ"; //Mã website tại VNPAY 
        $vnp_HashSecret = "VPIWAYEBTOGHANEAVNAYNGADABJHAMXN"; //Chuỗi bí mật
