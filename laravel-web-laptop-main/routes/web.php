...
Route::group([
    ...
    Route::get('/destroy-color/{color}', [ColorController::class, 'destroy_color'])->name('destroy-color');
    ...
    Route::get('/destroy-category/{category}', [CategoryController::class, 'destroy_category'])->name('destroy-category');
    ...
    Route::get('/destroy-brand/{brand}', [BrandController::class, 'destroy_brand'])->name('destroy-brand');
    ...
    Route::get('/destroy-coupon/{coupon}', [CouponController::class, 'destroy_coupon'])->name('destroy-coupon');
